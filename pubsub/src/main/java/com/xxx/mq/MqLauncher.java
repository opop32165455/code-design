...
public class MqLauncher {
    ...
    public static void main(String[] args) {
        ...
        Publisher<MqEvent> eventPublisher = new Publisher<MqEvent>(10)
                //.addSub(writeSub)
                .addSub(subscriber);
        ...
        IntStream.range(0, 40).forEach(i -> {
            ...
            eventPublisher.add(CollUtil.toList(MqEvent.builder().name(i).data(i).build()));
    ...
    private static void timerConsume(Publisher<MqEvent> eventPublisher) {
        LinkedBlockingDeque<MqEvent> events = eventPublisher.getCollection();
        consume(events);
